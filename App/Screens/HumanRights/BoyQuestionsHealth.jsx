...
export default function GirlQuestionsScreen({ route, navigation }) {
  ...
  const handleNextPress = () => {
    ...
    navigation.navigate('BoyHealthResult', { isCorrect, nextQuestionIndex: questionIndex + 1 });
  };

  return (
    <View>
      <View style={{ marginTop: 24, flexDirection: "row", alignItems: "center", justifyContent: "flex-start", marginHorizontal: 20 }}>
        <TouchableOpacity style={styles.Backbutton} onPress={() => navigation.navigate("BoyHomeHealth")}>
          <AntDesign name="left" size={20} color="#343A40" />
        </TouchableOpacity>
        <Text style={{ fontFamily: "outfit-bold", fontSize: 24, textAlign: "center", marginLeft: 65, color: "#343A40" }}>Boy's Right Health</Text>
      </View>
