...
export default function QuizCategory({navigation}) {
  ...
  return (
    <View >
      ...
      <TouchableOpacity style={{ backgroundColor: "#EFEEFC", padding: 10, marginHorizontal: 1, borderRadius: 20 ,marginTop:10}} onPress={()=>navigation.navigate("GirlRightScreen")}>
      ...
      <TouchableOpacity style={{ backgroundColor: "#EFEEFC", padding: 10, marginHorizontal: 1, borderRadius: 20 }} onPress={()=>navigation.navigate("GirlHomeHealth")}>
        <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: "white", padding: 16,marginHorizontal: 14, borderRadius: 20 }}>
          <View style={{ borderColor: "#EFEEFC", borderWidth: 2, width: 25, height: 25, borderRadius: 100, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', marginLeft: 10 }}>
      ...
      <TouchableOpacity style={{ backgroundColor: "#EFEEFC", padding: 10, marginHorizontal: 1, borderRadius: 20 }} onPress={()=>navigation.navigate("GirlHomeLife")}>
        <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: "white", padding: 16, marginHorizontal: 14, borderRadius: 20 }}>
          <View style={{ borderColor: "#EFEEFC", borderWidth: 2, width: 25, height: 25, borderRadius: 100, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', marginLeft: 10 }}>
      ...
      <TouchableOpacity style={{ backgroundColor: "#EFEEFC", padding: 10, marginHorizontal: 1, borderRadius: 20 }} onPress={()=>navigation.navigate("GirlHomeIdentity")} >
        <View style={{ flexDirection: "row", alignItems: "center", backgroundColor: "white", padding: 16, marginHorizontal: 14, borderRadius: 20 }}>
          <View style={{ borderColor: "#EFEEFC", borderWidth: 2, width: 25, height: 25, borderRadius: 100, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', marginLeft: 10 }}>
