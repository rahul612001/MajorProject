...
export default function GirlQuestionsScreen({ route, navigation }) {
  ...
  const handleNextPress = () => {
    ...
    navigation.navigate('GirlResultScreen', { isCorrect, nextQuestionIndex: questionIndex + 1 });
  };
  ...
  return (
    <View>
      <View style={{ marginTop: 24, flexDirection: "row", alignItems: "center", justifyContent: "flex-start", marginHorizontal: 20 }}>
        ...
        <Text style={{ fontFamily: "outfit-bold", fontSize: 24, textAlign: "center", marginLeft: 65,color:"#343A40" }}>Girl's Right Quiz</Text>
      </View>
