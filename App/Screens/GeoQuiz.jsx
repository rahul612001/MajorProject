...
const  Quiz= ({navigation})=>{
      ...
      const [isLoading,setIsLoading]=useState(false)
       ...
       const getQuiz=async()=>{
        setIsLoading(true)
        const url='https://opentdb.com/api.php?amount=10&category=22&difficulty=easy&type=multiple&encode=url3986';
    ...
    return (
      <View>
       <View style={{ width: "100%" ,marginBottom:-400}}>
        ...
        <Text style={{ fontFamily: "outfit-bold", fontSize: 24, textAlign: "center", marginLeft: 65,color:"#343A40" }}>Geography Quiz</Text>
      </View>
