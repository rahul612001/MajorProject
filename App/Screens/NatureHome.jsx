  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View >
        ...
        <View>
          <Text style={{ fontSize: 26, fontFamily: "outfit-bold", color: "#045688", textAlign: "center", backgroundColor: "white" }}>Nature Quiz</Text>
        </View>
      </View>

      <View style={{ alignItems: "center", }}>
        <Image source={require("../../assets/images/nature.png")}
          style={{ width: 320, height: 330, alignItems: "center", justifyContent: "center"}}
        />
      </View>
       ...
       <ImageBackground source={require("../../assets/images/image.png")}
         style={{width:"100%",height:190,transform: [{ rotate: '180deg' }]}}>
          <View>
          <TouchableOpacity onPress={() => navigation.navigate("NatureQuiz")} style={styles.button}>
        <View style={{flexDirection:"row"}}>
          <LottieView
            ...
            autoPlay={true}
          />
          <Text style={styles.buttonText}>Start Nature Quiz</Text>
        </View>
      </TouchableOpacity>
          </View>
       </ImageBackground>
