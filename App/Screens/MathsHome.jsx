  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={{ alignItems: "center", }}>
        <Image source={require("../../assets/images/maths2.png")}
          style={{ width: 490, height: 357, alignItems: "center", justifyContent: "center"}}
        />
      </View>
       ...
       <ImageBackground source={require("../../assets/images/image.png")}
         style={{width:"100%",height:190,transform: [{ rotate: '180deg' }]}}>
          <View>
          <TouchableOpacity onPress={() => navigation.navigate("MathsQuiz")} style={styles.button}>
        <View style={{flexDirection:"row"}}>
          <LottieView
            ...
            autoPlay={true}
          />
          <Text style={styles.buttonText}>Start Maths Quiz</Text>
        </View>
      </TouchableOpacity>
          </View>
       </ImageBackground>
